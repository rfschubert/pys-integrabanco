                ...
                if linha_numero >= self.LIQUIDACAO_LINHA_INICIAL:
                    if linha_numero < self.LIQUIDACAO_LINHA_FINAL:
                        ...
                        boleto = {
                            ...
                            "vencimento": pendulum.date(year=int("20" + vencimento[4:6]), month=int(vencimento[2:4]), day=int(vencimento[0:2])),
                            "data_pagamento": pendulum.date(year=int("20" + data_pagamento[4:6]), month=int(data_pagamento[2:4]), day=int(data_pagamento[0:2])),
